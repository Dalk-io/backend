...
void main() async {
  ...
  await pg.execute(
      'CREATE TABLE IF NOT EXISTS conversations (projectId TEXT NOT NULL, id TEXT NOT NULL, subject TEXT, avatar TEXT, admins json NOT NULL, users json NOT NULL, lastMessageCreatedAt TIMESTAMPTZ NOT NULL, isGroup boolean NOT NULL);');
  await pg.execute(
